// Signalfield/Data/SpecimenCatalog.swift
//
...
// All imageName values default to "specimen-placeholder" until real art is ready.
...
struct SpecimenCatalog {
    ...
    private static func buildAll() -> [Specimen] {
        ...
        for biomeId in 0...8 {
            let biomeName   = biomeNames[biomeId]
            let sqRange     = squareLevelRanges[biomeId]
            let hexRange    = hexLevelRanges[biomeId]

            // Specimens are numbered sequentially within each biome:
            // square levels first (1..N), then hex levels (N+1..N+M).
            var specimenNumber = 1
            ...
            for levelNumber in sqRange {
                ...
                specimens.append(Specimen(
                    id:         levelId,
                    name:       "\(biomeName) Specimen \(specimenNumber)",
                    imageName:  "specimen-placeholder",
                    biomeId:    biomeId,
                    isRare:     false,
                    levelId:    levelId,
                    isHex:      false
            ...
            specimens.append(Specimen(
                id:         "B\(biomeId)-hex",
                name:       "\(biomeName) Hex Rare Specimen",
                imageName:  "specimen-placeholder",
                biomeId:    biomeId,
                isRare:     true,
                levelId:    nil,
