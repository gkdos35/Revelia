# Revelia — Tile Visual System Spec + Cowork Prompt
...
**Read CLAUDE.md first.** Then read `reference/revelia-design-decisions.md` for biome mechanics context. Show me your plan before writing any code.
