// Revelia/Persistence/SpecimenStore.swift
//
...
///
/// Inject once as `@StateObject` in `ReveliaApp` and share as
...
final class SpecimenStore: ObservableObject {
    ...
    ///   the standard `~/Library/Application Support/Revelia/specimens.json` path.
