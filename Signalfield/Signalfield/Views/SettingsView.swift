// Signalfield/Views/SettingsView.swift
//
...
//   • Privacy Policy  — Opens signalfield.com/privacy in the default browser
...
struct SettingsView: View {
    ...
    var body: some View {
        ...
        .alert("Reset All Progress?", isPresented: $showResetConfirm) {
            ...
            Text("All level completions, stars, and scores will be permanently erased. This cannot be undone.")
        }
    }
        ...
        HStack {
            VStack(alignment: .leading, spacing: 2) {
                Text("Sound")
                    ...
                    .fontWeight(.medium)
                    .foregroundColor(sepiaBrown)
                Text("Tile interactions and ambiance")
    ...
    private func openPrivacyPolicy() {
        if let url = URL(string: "https://signalfield.com/privacy") {
