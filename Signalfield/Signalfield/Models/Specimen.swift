// Signalfield/Models/Specimen.swift
//
...
struct Specimen: Codable, Identifiable {
    ...
    ///
    /// Pattern:
    /// - Level specimens: `"[Biome Name] Specimen [N]"` (e.g. `"Training Range Specimen 1"`)
    /// - Square rare: `"[Biome Name] Rare Specimen"` (e.g. `"Training Range Rare Specimen"`)
    /// - Hex rare: `"[Biome Name] Hex Rare Specimen"` (e.g. `"Training Range Hex Rare Specimen"`)
    let name: String
