// Signalfield/Models/LevelSpec.swift
...
extension LevelSpec {
    ...
    static let coralBasin: [LevelSpec] = [
        // L47 — intro: 2 sonars → 2 intersection cells → ≈2 hazards
        LevelSpec(id: "L47", biomeId: 6, displayName: "Coral Basin 1",
                  boardWidth: 6,  boardHeight: 6,  hazardDensity: 0.06, parTimeSeconds: 90,
                  sonarCount: 2),
        // L48 — 3 sonars → 6 cells → ≈5 hazards
        LevelSpec(id: "L48", biomeId: 6, displayName: "Coral Basin 2",
                  boardWidth: 7,  boardHeight: 7,  hazardDensity: 0.10, parTimeSeconds: 120,
                  sonarCount: 3),
        // L49 — 3 sonars → 6 cells → ≈6 hazards
        LevelSpec(id: "L49", biomeId: 6, displayName: "Coral Basin 3",
                  boardWidth: 7,  boardHeight: 7,  hazardDensity: 0.12, parTimeSeconds: 120,
                  sonarCount: 3),
        // L50 — 4 sonars → 12 cells → ≈8 hazards
        LevelSpec(id: "L50", biomeId: 6, displayName: "Coral Basin 4",
                  boardWidth: 8,  boardHeight: 8,  hazardDensity: 0.13, parTimeSeconds: 150,
                  sonarCount: 4),
...
extension LevelSpec {
    ...
    static let coralBasinHex: [LevelSpec] = [
        ...
        LevelSpec(id: "L121", biomeId: 15, displayName: "Coral Basin: Hex Mode 1",
                  boardWidth: 6,  boardHeight: 6,  hazardDensity: 0.06, parTimeSeconds: 90,
                  sonarCount: 2, gridShape: .hexagonal),
        // k=3 → 6 cells
